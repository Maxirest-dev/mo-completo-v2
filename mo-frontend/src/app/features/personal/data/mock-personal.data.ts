...
export const MOCK_EMPLEADOS: Empleado[] = [
  { id: 'e-001', nombre: 'María López', avatar: '', rol: 'Mozo', estado: 'Trabajando', dni: '35.678.901', cuil: '27-35678901-4', telefono: '11-4567-8901', contactoEmergencia: '11-9876-5432', fechaIngreso: '2024-03-15', sueldoBase: 380000, valorHoraExtra: 3200, diasFranco: ['Domingo', 'Lunes'] },
  { id: 'e-002', nombre: 'Carlos Ruiz', avatar: '', rol: 'Cocinero', estado: 'Trabajando', dni: '31.234.567', cuil: '20-31234567-8', telefono: '11-2345-6789', contactoEmergencia: '11-8765-4321', fechaIngreso: '2023-08-01', sueldoBase: 420000, valorHoraExtra: 3500, diasFranco: ['Lunes', 'Martes'] },
  { id: 'e-003', nombre: 'Ana Torres', avatar: '', rol: 'Bachero', estado: 'Franco', dni: '38.901.234', cuil: '27-38901234-6', telefono: '11-3456-7890', contactoEmergencia: '11-7654-3210', fechaIngreso: '2025-01-10', sueldoBase: 310000, valorHoraExtra: 2600, diasFranco: ['Miércoles', 'Jueves'] },
  { id: 'e-004', nombre: 'Diego Martín', avatar: '', rol: 'Bartender', estado: 'Trabajando', dni: '33.456.789', cuil: '20-33456789-2', telefono: '11-4567-1234', contactoEmergencia: '11-6543-2109', fechaIngreso: '2024-06-20', sueldoBase: 390000, valorHoraExtra: 3300, diasFranco: ['Domingo', 'Lunes'] },
  { id: 'e-005', nombre: 'Laura Sánchez', avatar: '', rol: 'Manager', estado: 'Trabajando', dni: '29.876.543', cuil: '27-29876543-0', telefono: '11-5678-2345', contactoEmergencia: '11-5432-1098', fechaIngreso: '2022-11-05', sueldoBase: 520000, valorHoraExtra: 4300, diasFranco: ['Domingo'] },
  { id: 'e-006', nombre: 'Pablo Herrera', avatar: '', rol: 'Cocinero', estado: 'Franco', dni: '36.543.210', cuil: '20-36543210-4', telefono: '11-6789-3456', contactoEmergencia: '11-4321-0987', fechaIngreso: '2024-09-12', sueldoBase: 400000, valorHoraExtra: 3400, diasFranco: ['Martes', 'Miércoles'] },
  { id: 'e-007', nombre: 'Valentina Díaz', avatar: '', rol: 'Mozo', estado: 'Vacaciones', dni: '37.210.987', cuil: '27-37210987-8', telefono: '11-7890-4567', contactoEmergencia: '11-3210-9876', fechaIngreso: '2024-01-08', sueldoBase: 370000, valorHoraExtra: 3100, diasFranco: ['Domingo', 'Lunes'] },
  { id: 'e-008', nombre: 'Facundo Gómez', avatar: '', rol: 'Bachero', estado: 'Trabajando', dni: '39.654.321', cuil: '20-39654321-6', telefono: '11-8901-5678', contactoEmergencia: '11-2109-8765', fechaIngreso: '2025-02-20', sueldoBase: 310000, valorHoraExtra: 2600, diasFranco: ['Jueves', 'Viernes'] },
];
