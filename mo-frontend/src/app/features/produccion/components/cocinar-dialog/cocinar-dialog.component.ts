...
@Component({
          ...
          <div class="formula-section">
            ...
            @if (item.tipo === 'TRANSFORMACION') {
              <div class="formula-row">
                ...
                <svg class="formula-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F97316" stroke-width="2">
  ...
  styles: [`
    ...
    .dialog-title { font-size: 22px; font-weight: 600; color: #1F2937; margin: 0; }
    .dialog-item-name { font-size: 16px; color: #6B7280; margin: 6px 0 0; font-weight: 500; }
    ...
    .tipo-elaborado { background: #FEF3C7; color: #92400E; }

    .dialog-body { padding: 24px 28px; }
    .section-label { display: block; font-size: 11px; font-weight: 600; color: #9CA3AF; text-transform: uppercase; letter-spacing: 0.04em; margin-bottom: 8px; }

    /* Formula */
    .formula-section { margin-bottom: 20px; }
    .formula-row { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; padding: 12px 14px; background: #F9FAFB; border-radius: 8px; }
    .formula-origen { font-weight: 600; color: #1F2937; }
    .formula-arrow { flex-shrink: 0; }
    .formula-tipo-badge {
      padding: 3px 10px; font-size: 12px; font-weight: 600;
      background: #FFF7ED; color: #EA580C; border: 1px solid #FDBA74; border-radius: 6px; text-transform: capitalize;
    }
    .formula-resultado { font-weight: 600; color: #059669; }
    .ingredientes-list { padding: 8px 14px; background: #F9FAFB; border-radius: 8px; }
    .ing-row { display: flex; align-items: center; gap: 8px; padding: 4px 0; font-size: 14px; color: #374151; }
    .ing-dot { width: 6px; height: 6px; border-radius: 50%; background: #F97316; flex-shrink: 0; }
    .formula-resultado-elab { margin-top: 8px; font-size: 13px; color: #6B7280; }

    /* Stock info */
    .stock-info { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 20px; }
    .stock-card { display: flex; flex-direction: column; gap: 4px; padding: 12px 14px; background: #F9FAFB; border-radius: 8px; }
    .stock-label { font-size: 12px; color: #9CA3AF; font-weight: 500; }
    .stock-value { font-size: 16px; font-weight: 700; color: #1F2937; }
    ...
    .cantidad-input:focus { outline: none; border-color: #F97316; box-shadow: 0 0 0 3px rgba(249,115,22,0.1); }
    .error-msg { display: block; margin-top: 6px; font-size: 12px; color: #EF4444; }

    /* Preview */
    .preview-section { }
    .preview-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
    .preview-item { display: flex; flex-direction: column; gap: 4px; padding: 10px 12px; background: #F9FAFB; border-radius: 8px; }
    .preview-label { font-size: 11px; color: #9CA3AF; font-weight: 500; }
    .preview-value { font-size: 14px; font-weight: 700; color: #1F2937; }
